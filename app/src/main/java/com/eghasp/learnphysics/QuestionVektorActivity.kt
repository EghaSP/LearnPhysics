...
class QuestionVektorActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_question_vektor)

        mQuestionsList = ConstantVektor.getQuestions()
        setQuestion()
            ...
            R.id.btn_submit ->{
                if(mSelectedOptionPosition == 0){
                    ...
                    when{
                        ...
                        val intent = Intent(this, ResultVektorActivity::class.java)
                        intent.putExtra(ConstantVektor.CORRECT_ANSWER, mCorrectAnswers)
                        intent.putExtra(ConstantVektor.TOTAL_QUESTION, mQuestionsList!!.size)
