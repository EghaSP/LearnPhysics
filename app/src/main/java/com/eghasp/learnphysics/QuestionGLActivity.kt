...
class QuestionGLActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_question_gl)

        mQuestionsList = ConstantGL.getQuestions()
        setQuestion()
            ...
            R.id.btn_submit ->{
                if(mSelectedOptionPosition == 0){
                    ...
                    when{
                        ...
                        val intent = Intent(this, ResultGLActivity::class.java)
